...
function t8_cmesh_new_periodic_hybrid_2d(comm)
  ...
  # 5. Classification of the vertices for each tree.
  t8_cmesh_set_tree_vertices(cmesh, 0, pointer(vertices), 3)
  t8_cmesh_set_tree_vertices(cmesh, 1, pointer(vertices, 10), 3)
  t8_cmesh_set_tree_vertices(cmesh, 2, pointer(vertices, 19), 4)
  t8_cmesh_set_tree_vertices(cmesh, 3, pointer(vertices, 31), 4)
  t8_cmesh_set_tree_vertices(cmesh, 4, pointer(vertices, 43), 3)
  t8_cmesh_set_tree_vertices(cmesh, 5, pointer(vertices, 52), 3)
